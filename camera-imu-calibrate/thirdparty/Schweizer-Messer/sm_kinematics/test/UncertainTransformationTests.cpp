...
TEST(UncertainTransformationTestSuite, testConstructor) {
  ...
  sm::eigen::assertNear(
      T, T_a_b.T(), 1e-10, SM_SOURCE_FILE_POS,
      "Checking for the default constructor creating identity");
  sm::eigen::assertNear(
      U, T_a_b.U(), 1e-10, SM_SOURCE_FILE_POS,
...
TEST(UncertainTransformationTestSuite, testTV4Multiplication) {
  ...
  for (int i = 0; i < 100; i++) {
    ...
    sm::eigen::assertNear(
        v_a, v_a_prime, 1e-10, SM_SOURCE_FILE_POS,
...
TEST(UncertainTransformationTestSuite, testTVhMultiplication) {
  ...
  for (int i = 0; i < 100; i++) {
    ...
    sm::eigen::assertNear(
        V_a.toEuclidean(), v_a, 1e-10, SM_SOURCE_FILE_POS,
        "Checking for composition equal to matrix multiplication");
  }
}
...
TEST(UncertainTransformationTestSuite, testTTMultiplication) {
  try {
    ...
    for (int i = 0; i < 100; i++) {
      ...
      sm::eigen::assertNear(
          T_a_c.T(), T_a_c_prime, 1e-10, SM_SOURCE_FILE_POS,
          "Checking for composition equal to matrix multiplication");
    }
...
TEST(UncertainTransformationTestSuite, testInvert) {
  ...
  for (int i = 0; i < 100; i++) {
    ...
    sm::eigen::assertNear(T_a_b_prime.T(), T_a_b.T(), 1e-10, SM_SOURCE_FILE_POS,
...
TEST(UncertainTransformationTestSuite, testInvertProducesIdentity) {
  ...
  for (int i = 0; i < 100; i++) {
    ...
    sm::eigen::assertNear(Eye1.T(), Eigen::Matrix4d::Identity(), 1e-10,
                          SM_SOURCE_FILE_POS, "Checking for identity");
    sm::eigen::assertNear(Eye2.T(), Eigen::Matrix4d::Identity(), 1e-10,
                          SM_SOURCE_FILE_POS, "Checking for identity");
  }
}
...
TEST(UncertainTransformationTestSuite, testInverse) {
  ...
  sm::eigen::assertNear(
      r1_T_01, r2_T_01, 1e-10, SM_SOURCE_FILE_POS,
  ...
  sm::eigen::assertNear(
      r1_U_01, r2_U_01, 1e-10, SM_SOURCE_FILE_POS,
      "Testing that composition and inverse derive the same answer");
}
...
TEST(UncertainTransformationTestSuite, testTVMultiplication2) {
  ...
  for (int i = 0; i < 10; i++) {
    ...
    sm::eigen::assertNear(
        v_a.toEuclidean(), v_a_prime, 1e-10, SM_SOURCE_FILE_POS,
        "Checking for composition equal to matrix multiplication");
  }
}
...
TEST(UncertainTransformationTestSuite, testUOplus) {
  ...
  for (int i = 0; i < 10; i++) {
    ...
    sm::eigen::assertNear(
        T_a_b_1.U(), T_a_b_2.U(), 1e-10, SM_SOURCE_FILE_POS,
