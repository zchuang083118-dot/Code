...
namespace sm { namespace boost_serialization {
        ...
        template<typename T>
        void save(T & object, std::filesystem::path const & filename)
        {
        ...
        template<typename T>
        void load(T & object, std::filesystem::path const & filename)
        {
        ...
        template <typename T>
        void save_txt(T& object, std::filesystem::path const& filename) {
          std::ofstream ofs(filename.string().c_str(), std::ios::binary);
        ...
        template <typename T>
        void load_txt(T& object, std::filesystem::path const& filename) {
          std::ifstream ifs(filename.string().c_str(), std::ios::binary);
        ...
        template <typename T>
        void save_xml(T& object, std::string topLevelXmlTag,
          ...
          oa << ::boost::serialization::make_nvp(topLevelXmlTag.c_str(),
                                                 object);
        }

        template <typename T>
        void load_xml(T& object, std::string topLevelXmlTag,
                      std::filesystem::path const& filename) {
          ...
          ia >>
              ::boost::serialization::make_nvp(topLevelXmlTag.c_str(), object);
        }

        template <typename T>
        void save_xml(T& object, std::filesystem::path const& filename) {
          save_xml(object, "object", filename);
        }

        template<typename T>
        void load_xml(T & object, std::filesystem::path const & filename)
        {
