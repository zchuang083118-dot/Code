...
double randLU(double lowerBoundInclusive, double upperBoundExclusive) {
  return Random::instance().uniform() *
             (upperBoundExclusive - lowerBoundInclusive) +
         lowerBoundInclusive;
}

int randLUi(int lowerBoundInclusive, int upperBoundExclusive) {
  return (int)floor(Random::instance().uniform() *
                    (upperBoundExclusive - lowerBoundInclusive)) +
         lowerBoundInclusive;
}

void seed(uint64_t s) { Random::instance().seed(s); }
