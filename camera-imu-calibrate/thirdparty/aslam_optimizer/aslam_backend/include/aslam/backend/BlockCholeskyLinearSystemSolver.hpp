...
class BlockCholeskyLinearSystemSolver : public LinearSystemSolver {
 public:
  ...
  /// \brief solve the system storing the solution in outDx and returning true
  /// on success.
  ...
  /// Helper Function for DogLeg implementation; returns parts required for the
 ...
 private:
  ...
  /// \brief initialized the matrix structure for the problem with these error
  /// terms and errors.
