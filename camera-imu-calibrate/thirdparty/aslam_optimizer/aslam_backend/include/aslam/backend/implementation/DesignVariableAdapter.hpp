...
template <typename T>
DesignVariableAdapter<T>::DesignVariableAdapter(T* dv,
                                                bool adapterOwnsPointer) {
...
template <typename T>
DesignVariableAdapter<T>::DesignVariableAdapter(const std::shared_ptr<T>& dv)
    : _dv(dv) {}
...
template <typename T>
void DesignVariableAdapter<T>::updateImplementation(const double* dp,
                                                    int /* size */) {
...
template <typename T>
std::shared_ptr<T> DesignVariableAdapter<T>::valuePtr() {
  return _dv;
}
template <typename T>
std::shared_ptr<const T> DesignVariableAdapter<T>::constValuePtr() const {
  return _dv;
}
...
template <typename T>
void DesignVariableAdapter<T>::minimalDifferenceImplementation(
...
template <typename T>
void DesignVariableAdapter<T>::minimalDifferenceAndJacobianImplementation(
