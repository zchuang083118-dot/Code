...
template <typename Scalar_>
void GenericScalarExpression<Scalar_>::evaluateJacobians(
...
template <typename Scalar_>
void GenericScalarExpression<Scalar_>::getDesignVariables(
...
class GSEUnRes : public GenericScalarExpressionNode<Scalar_> {
 public:
  ...
  typedef std::shared_ptr<NodeType_> SharedNodePointer;
...
class GSEBinRes : public GenericScalarExpressionNode<Scalar_> {
 public:
  ...
  GSEBinRes(SharedNodePointer lhs, SharedNodePointer rhs)
      : _lhs(lhs), _rhs(rhs) {}
  virtual ~GSEBinRes() {}
...
class GenericScalarExpressionNodeCasted
    : public GSEUnRes<Scalar_, GenericScalarExpressionNode<OtherScalar_> > {
 public:
 ...
 protected:
  ...
  void evaluateJacobiansImplementation(
    ...
    if (applyChainRule) {
      ...
      this->_lhs->evaluateJacobians(
          outJacobians, Eigen::Matrix<double, 1, 1>::Identity(1, 1));
    }
  }
};

template <typename Scalar_>
class GenericScalarExpressionNodeConstant
    : public GenericScalarExpressionNode<Scalar_> {
 public:
  typedef GenericScalarExpressionNode<Scalar_> Base;
...
class GenericScalarExpressionNodeMultiply : public GSEBinRes<Scalar_> {
 public:
  ...
  typedef typename Base::SharedNodePointer SharedNodePointer;
  GenericScalarExpressionNodeMultiply(SharedNodePointer lhs,
                                      SharedNodePointer rhs)
      : Base(lhs, rhs) {}
 ...
 protected:
  ...
  void evaluateJacobiansImplementation(
    ...
    this->_lhs->evaluateJacobians(outJacobians,
                                  applyChainRule ? *applyChainRule * R : R);
    this->_rhs->evaluateJacobians(outJacobians,
                                  applyChainRule ? *applyChainRule * L : L);
  }
};
...
class GenericScalarExpressionNodeDivide : public GSEBinRes<Scalar_> {
 public:
  typedef GSEBinRes<Scalar_> Base;
  typedef typename Base::SharedNodePointer SharedNodePointer;
  GenericScalarExpressionNodeDivide(SharedNodePointer lhs,
                                    SharedNodePointer rhs)
      : Base(lhs, rhs) {}
 ...
 protected:
  ...
  void evaluateJacobiansImplementation(
    ...
    R(0, 0) = -this->_lhs->toScalar() /
              (this->_rhs->toScalar() * this->_rhs->toScalar());
    this->_lhs->evaluateJacobians(outJacobians,
                                  applyChainRule ? *applyChainRule * R : R);
    this->_rhs->evaluateJacobians(outJacobians,
                                  applyChainRule ? *applyChainRule * L : L);
...
class GenericScalarExpressionNodeAdd : public GSEBinRes<Scalar_> {
 public:
  typedef GSEBinRes<Scalar_> Base;
  typedef typename Base::SharedNodePointer SharedNodePointer;
  GenericScalarExpressionNodeAdd(SharedNodePointer lhs, SharedNodePointer rhs)
      : Base(lhs, rhs) {}
...
class GenericScalarExpressionNodeSub : public GSEBinRes<Scalar_> {
 public:
  typedef GSEBinRes<Scalar_> Base;
  typedef typename Base::SharedNodePointer SharedNodePointer;
  GenericScalarExpressionNodeSub(SharedNodePointer lhs, SharedNodePointer rhs)
      : Base(lhs, rhs) {}
...
template <typename Scalar_>
class GenericScalarExpressionNodeNegated
    : public GSEUnRes<Scalar_, GenericScalarExpressionNode<Scalar_> > {
 public:
...
template <typename Scalar_>
class GenericScalarExpressionNodeFromVectorExpression
    : public GSEUnRes<Scalar_, VectorExpressionNode<1> > {
 public:
  typedef GSEUnRes<Scalar_, VectorExpressionNode<1> > Base;
  typedef typename Base::SharedNodePointer SharedNodePointer;
  GenericScalarExpressionNodeFromVectorExpression(SharedNodePointer lhs)
      : Base(lhs) {}
...
inline GenericScalarExpression<Scalar_>::GenericScalarExpression(
    const GenericScalarExpression<OtherScalar>& other)
    : _root(
          new internal::GenericScalarExpressionNodeCasted<Scalar_, OtherScalar>(
              other._root)) {}

template <typename Scalar_>
GenericScalarExpression<Scalar_>::GenericScalarExpression(
    NodeType* node, bool expressionOwnsNode)
    : _root(expressionOwnsNode ? SharedNodePointer(node)
                               : SharedNodePointer(node, sm::null_deleter())) {}

template <typename Scalar_>
GenericScalarExpression<Scalar_> GenericScalarExpression<Scalar_>::operator+(
    const GenericScalarExpression& s) {
  return SharedNodePointer(
      new internal::GenericScalarExpressionNodeAdd<Scalar_>(_root, s._root));
}

template <typename Scalar_>
GenericScalarExpression<Scalar_> GenericScalarExpression<Scalar_>::operator-() {
  return SharedNodePointer(
      new internal::GenericScalarExpressionNodeNegated<Scalar_>(_root));
}
...
GenericScalarExpression<Scalar_> GenericScalarExpression<Scalar_>::operator-(
    const GenericScalarExpression& s) {
  return SharedNodePointer(
      new internal::GenericScalarExpressionNodeSub<Scalar_>(_root, s._root));
}
...
GenericScalarExpression<Scalar_> GenericScalarExpression<Scalar_>::operator/(
    const GenericScalarExpression& s) {
  return SharedNodePointer(
      new internal::GenericScalarExpressionNodeDivide<Scalar_>(_root, s._root));
}
...
GenericScalarExpression<Scalar_> GenericScalarExpression<Scalar_>::operator*(
    const GenericScalarExpression& s) {
  return SharedNodePointer(
      new internal::GenericScalarExpressionNodeMultiply<Scalar_>(_root,
                                                                 s._root));
}
