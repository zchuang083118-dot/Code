...
class EuclideanExpressionNodeMultiply : public EuclideanExpressionNode {
 public:
  ...
  EuclideanExpressionNodeMultiply(std::shared_ptr<RotationExpressionNode> lhs,
 ...
 private:
  ...
  std::shared_ptr<RotationExpressionNode> _lhs;
  mutable Eigen::Matrix3d _C_lhs;
  std::shared_ptr<EuclideanExpressionNode> _rhs;
 ...
 *
 * \brief A class representing the multiplication of a Matrix with a euclidean
 * Vector.
 *
 */
class EuclideanExpressionNodeMatrixMultiply : public EuclideanExpressionNode {
 ...
 private:
  ...
  std::shared_ptr<MatrixExpressionNode> _lhs;
...
class EuclideanExpressionNodeCrossEuclidean : public EuclideanExpressionNode {
 ...
 private:
  ...
  std::shared_ptr<EuclideanExpressionNode> _lhs;
  std::shared_ptr<EuclideanExpressionNode> _rhs;
};
...
class EuclideanExpressionNodeAddEuclidean : public EuclideanExpressionNode {
 public:
  ...
  EuclideanExpressionNodeAddEuclidean(
      std::shared_ptr<EuclideanExpressionNode> lhs,
      std::shared_ptr<EuclideanExpressionNode> rhs);
 ...
 */
class EuclideanExpressionNodeSubtractEuclidean
    : public EuclideanExpressionNode {
 public:
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW
 ...
 *
 * \brief A class representing the subtraction of a vector from an Euclidean
 * expression.
 *
 */
...
class EuclideanExpressionNodeNegated : public EuclideanExpressionNode {
 public:
  ...
  EuclideanExpressionNodeNegated(
 ...
 private:
  ...
  std::shared_ptr<EuclideanExpressionNode> _operand;
};

/**
 * \class EuclideanExpressionNodeScalarMultiply
 *
 * \brief A class representing the multiplication of a ScalarExpression with an
...
class EuclideanExpressionNodeScalarMultiply : public EuclideanExpressionNode {
 ...
 private:
  ...
  std::shared_ptr<ScalarExpressionNode> _s;
};
...
class VectorExpression2EuclideanExpressionAdapter
 ...
 private:
  ...
  std::shared_ptr<VectorExpressionNode<3> > _vectorExpressionNode;
};
...
class EuclideanExpressionNodeTranslation : public EuclideanExpressionNode {
 public:
  ...
  EuclideanExpressionNodeTranslation(
 ...
 private:
  ...
  std::shared_ptr<TransformationExpressionNode> _operand;
};

class EuclideanExpressionNodeRotationParameters
    : public EuclideanExpressionNode {
 public:
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW
 ...
 private:
  ...
  std::shared_ptr<RotationExpressionNode> _operand;
...
class EuclideanExpressionNodeFromHomogeneous : public EuclideanExpressionNode {
 ...
 private:
  ...
  std::shared_ptr<HomogeneousExpressionNode> _root;
};

/**
 * \class EuclideanExpressionNodeElementwiseMultiplyEuclidean
 *
 * \brief A class representing the elementwise product of two euclidean
 * expressions.
 *
 */
class EuclideanExpressionNodeElementwiseMultiplyEuclidean
