...
class ScalarExpressionNodeMultiply : public ScalarExpressionNode {
 public:
  ...
  ScalarExpressionNodeMultiply(std::shared_ptr<ScalarExpressionNode> lhs,
 ...
 protected:
  ...
  std::shared_ptr<ScalarExpressionNode> _lhs;
  std::shared_ptr<ScalarExpressionNode> _rhs;
};
...
class ScalarExpressionNodeDivide : public ScalarExpressionNode {
 public:
  ...
  ScalarExpressionNodeDivide(std::shared_ptr<ScalarExpressionNode> lhs,
                             std::shared_ptr<ScalarExpressionNode> rhs);
...
class ScalarExpressionNodeAdd : public ScalarExpressionNode {
 public:
  ...
  ScalarExpressionNodeAdd(std::shared_ptr<ScalarExpressionNode> lhs,
                          std::shared_ptr<ScalarExpressionNode> rhs,
...
class ScalarExpressionNodeFromVectorExpression : public ScalarExpressionNode {
 ...
 protected:
  ...
  std::shared_ptr<VectorExpressionNode<1> > _lhs;
};
