...
class EuclideanExpression {
 public:
  ...
  EuclideanExpression(std::shared_ptr<EuclideanExpressionNode> designVariable);
  ...
  std::shared_ptr<EuclideanExpressionNode> root() { return _root; }
 ...
 private:
  ...
  std::shared_ptr<EuclideanExpressionNode> _root;
};
