...
class RotationExpressionNodeMultiply : public RotationExpressionNode {
 public:
  ...
  RotationExpressionNodeMultiply(std::shared_ptr<RotationExpressionNode> lhs,
 ...
 private:
  ...
  std::shared_ptr<RotationExpressionNode> _rhs;
...
class RotationExpressionNodeInverse : public RotationExpressionNode {
 ...
 private:
  ...
  std::shared_ptr<RotationExpressionNode> _dvRotation;
  mutable Eigen::Matrix3d _C;
};

class RotationExpressionNodeTransformation : public RotationExpressionNode {
 public:
  RotationExpressionNodeTransformation(
      std::shared_ptr<TransformationExpressionNode> dvRotation);
 ...
 private:
  ...
  std::shared_ptr<TransformationExpressionNode> _transformation;
};
