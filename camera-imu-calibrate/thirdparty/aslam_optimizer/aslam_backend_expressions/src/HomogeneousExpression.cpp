...
HomogeneousExpression::~HomogeneousExpression() {}
HomogeneousExpression::HomogeneousExpression(
    HomogeneousExpressionNode* designVariable)
    : _root(designVariable, sm::null_deleter()) {}

HomogeneousExpression::HomogeneousExpression(
    std::shared_ptr<HomogeneousExpressionNode> designVariable)
...
EuclideanExpression HomogeneousExpression::toEuclideanExpression() const {
  std::shared_ptr<EuclideanExpressionNode> newRoot(
      new EuclideanExpressionNodeFromHomogeneous(_root));
  return EuclideanExpression(newRoot);
}

void HomogeneousExpression::evaluateJacobians(
...
void HomogeneousExpression::getDesignVariables(
