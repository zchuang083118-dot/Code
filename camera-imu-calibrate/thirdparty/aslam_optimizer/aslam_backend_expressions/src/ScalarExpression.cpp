...
ScalarExpression::ScalarExpression(std::shared_ptr<ScalarExpressionNode> root)
    : _root(root) {}
...
void ScalarExpression::evaluateJacobians(
...
void ScalarExpression::getDesignVariables(
...
ScalarExpression ScalarExpression::operator+(const ScalarExpression& s) {
  std::shared_ptr<ScalarExpressionNode> newRoot(
      new ScalarExpressionNodeAdd(_root, s._root));
  return ScalarExpression(newRoot);
}

ScalarExpression ScalarExpression::operator-(const ScalarExpression& s) {
  std::shared_ptr<ScalarExpressionNode> newRoot(
      new ScalarExpressionNodeAdd(_root, s._root, -1.0));
  return ScalarExpression(newRoot);
}

ScalarExpression ScalarExpression::operator-(double s) {
  std::shared_ptr<ScalarExpressionNode> constant(
      new ScalarExpressionNodeConstant(-s));
  std::shared_ptr<ScalarExpressionNode> newRoot(
      new ScalarExpressionNodeAdd(_root, constant));
  return ScalarExpression(newRoot);
}

ScalarExpression ScalarExpression::operator/(const ScalarExpression& s) {
  std::shared_ptr<ScalarExpressionNode> newRoot(
      new ScalarExpressionNodeDivide(_root, s._root));
  return ScalarExpression(newRoot);
}
...
ScalarExpression ScalarExpression::operator/(double s) {
  std::shared_ptr<ScalarExpressionNode> constant(
      new ScalarExpressionNodeConstant(s));
  std::shared_ptr<ScalarExpressionNode> newRoot(
      new ScalarExpressionNodeDivide(_root, constant));
  return ScalarExpression(newRoot);
}
...
ScalarExpression ScalarExpression::operator*(double s) {
  std::shared_ptr<ScalarExpressionNode> constant(
      new ScalarExpressionNodeConstant(s));
  std::shared_ptr<ScalarExpressionNode> newRoot(
      new ScalarExpressionNodeMultiply(_root, constant));
  return ScalarExpression(newRoot);
}

ScalarExpression ScalarExpression::operator*(const ScalarExpression& s) {
  std::shared_ptr<ScalarExpressionNode> newRoot(
      new ScalarExpressionNodeMultiply(_root, s._root));
  return ScalarExpression(newRoot);
}
