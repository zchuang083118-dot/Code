...
template <typename CAMERA_T>
std::shared_ptr<typename NullUndistorter<CAMERA_T>::ideal_geometry_t>
NullUndistorter<CAMERA_T>::idealGeometry() const {
  return _idealGeometry;
}

template <typename CAMERA_T>
std::shared_ptr<typename NullUndistorter<CAMERA_T>::ideal_geometry_t>
NullUndistorter<CAMERA_T>::distortedGeometry() const {
  return _idealGeometry;
}
...
void NullUndistorter<CAMERA_T>::setIdealGeometry(
  ...
  _idealGeometry = std::shared_ptr<ideal_geometry_t>(new ideal_geometry_t(
      distortedGeometry->projection(), distortedGeometry->shutter(),
...
template <typename CAMERA_T>
std::shared_ptr<FrameBase> NullUndistorter<CAMERA_T>::buildFrame(
    cv::Mat& inImage) {
