...
class KeypointBase {
 public:
  ...
  /// \brief get the keypoint descriptor
  virtual std::shared_ptr<DescriptorBase> descriptorPtr() const = 0;
  ...
  /// \brief set the keypoint descriptor
  ///        the keypoint takes ownership of the pointer
  virtual void setDescriptorPtr(std::shared_ptr<DescriptorBase> descriptor) = 0;
  ...
  virtual const sm::kinematics::UncertainHomogeneousPoint* landmarkPtr()
      const = 0;
