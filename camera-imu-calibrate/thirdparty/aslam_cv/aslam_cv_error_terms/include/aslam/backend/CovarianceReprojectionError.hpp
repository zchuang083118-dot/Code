...
class CovarianceReprojectionError
    : public ErrorTermFs<FRAME_T::KeypointDimension> {
 public:
  ...
  enum {
    KeypointDimension =
        frame_t::KeypointDimension /*!< The dimension of the keypoint associated
                                      with this geometry policy */
  };
  ...
  CovarianceReprojectionError(const frame_t* frame, int keypointIndex,
