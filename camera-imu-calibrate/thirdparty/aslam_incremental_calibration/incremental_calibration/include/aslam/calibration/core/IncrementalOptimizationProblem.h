...
class IncrementalOptimizationProblem
 ...
 public:
  ...
  typedef std::shared_ptr<OptimizationProblem> OptimizationProblemSP;
  ...
  typedef std::unordered_map<const DesignVariable*, std::pair<size_t, size_t> >
      DesignVariablesPCountId;
  ...
  typedef std::shared_ptr<ErrorTerm> ErrorTermSP;
  ...
  const OptimizationProblem* getOptimizationProblem(
      const OptimizationProblemsSPCIt& problemIt) const;
  /// Returns an optimization problem from an iterator
  OptimizationProblem* getOptimizationProblem(
  ...
  OptimizationProblemsSPIt getOptimizationProblem(
